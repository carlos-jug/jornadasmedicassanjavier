...
<div id="body_2">
	<div id="cont_body_left">
    	    	<div id="li_cont">
        	<div id="tt_cont">Comité Organizador</div>
            <div id="tx_cont_nav"><a href="Index.php">Inicio</a> / Información general / Comité Organizador</div>
        </div>
                <div id="cont_home_tx">
                                 
                  
                  <p><strong>Dr. Juan José Salazar del Valle</strong><br />

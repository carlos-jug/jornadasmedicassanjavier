<?php
$imgsDir = 'galeria/2015/';
include_once("utils/CargarImagenes.php");
?>
...
<script type="text/javascript">$(function(){$('div.Galeria a[rel^=lightbox]').lightBox();});</script>
</head>
...
<div id="body_2">
  <div id="cont_body_left">
    <div id="li_cont">
      <div id="tt_cont">Edición 2015</div>
      <div id="tx_cont_nav"><a href="./">Inicio</a> / Ediciones / 2015</div>
    </div>
    <div id="cont_home_tx">
      <p class="tx_tt">2015</p>
      <p>
        <div class="Galeria">
	<?php
		foreach ( $loadedImages as $Image )
		{
	?>
          <a rel="lightbox" href="<?php echo $imgsDir.$Image;?>"><img src="<?php echo $imgsDir.$Image;?>" /></a>
	<?php
		}
	?>
        </div>
